...
// We noemen zo'n "terugval-optie" ook wel een 'polyfill. Functionaliteit toevoegen, indien het niet door de browser wordt ondersteund. Je voorkomt daar een mogelijke "breach" in je code mee!
...
// In principe wordt deze functie door alle moderne browsers ondersteund. Toch kan het voorkomen dat een wat oudere browser het niet ondersteund. 
// Met name in de tijd dat deze functie nog erg nieuw was en niet overal werd ondersteund, was een polyfill vanzelfsprekend opgenomen in je code. 
// Onderstaande functie-definitie is dus een functie die de beste optie zal uitkiezen voor 'window.requestAnimFrame' en is afhankelijk van de browser die de gebruiker heeft.
...
// Onderstaande functie hebben we in object 'game' en object 'ball' nodig. Ik kies er daarom voor nu maar even voor om de functie in 'polyfill' op te nemen, zodat de functie globaal beschikbaar is.
